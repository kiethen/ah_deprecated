...
local tSearchSort = {
	[1] = {
		...
		nTypeID = 7,
		tSubSort = {
			L("STR_PRODUCE_PARRYVALUE"), L("STR_PRODUCE_SHIELD"), L("STR_PRODUCE_THREAT"), L("STR_PRODUCE_PHYSICSATTACK"),
			L("STR_PRODUCE_PHYSICSHIT"), L("STR_PRODUCE_PHYSICSCRITICALSTRIKE"), L("STR_PRODUCE_PHYSICSCRITICALDAMAGE"),
